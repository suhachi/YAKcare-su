...
환경 설정 및 기능 플래그를 중앙 관리하는 파일입니다.

### 주요 기능

1. **환경 변수 관리**
   - Firebase, GA4, Sentry, Figma 설정
   - 안전한 환경 변수 접근 헬퍼 함수

2. **기능 플래그 시스템**
   - Progressive Rollout 지원
   - 알림, 보호자, 건강 기록, QR/OCR 기능 활성화/비활성화
   - 백엔드 전환 (Supabase/Firestore/Mock)
